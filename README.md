...
The easiest way to use this project is through the modern Streamlit web interface with glassmorphism design:
...
- View the generated blog with beautiful formatting
- Copy or download the blog content

### Option 2: Command Line

To kickstart your crew of AI agents and begin task execution from the command line, run this from the root folder of your project:
